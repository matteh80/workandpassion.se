...
<header class="banner videobanner">
        ...
        <div class="header-text container-fluid d-flex flex-column justify-content-center align-items-center">
            <h1 class="title text-center font-subheadings"><i>Rätt jobb</i> eller <i>rätt person?</i></h1>
            <h1 class="title text-center font-subheadings">Hitta båda här.</h1>
            <h3 class="subtitle text-center font-headings">Matchning värd varje krona och sekund.</h3>
