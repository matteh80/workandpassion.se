...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_landing.css', array(), '', 'all' );

global $detheme_config,$post,$detheme_config_demo10;

if(isset($detheme_config_demo10)) {
	$detheme_config=$detheme_config_demo10;
}
