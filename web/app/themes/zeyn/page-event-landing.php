...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo15.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo15,$post;

if(isset($detheme_config_demo15)) {
	$detheme_config=$detheme_config_demo15;
}
get_header();
