...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo17.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo17,$post;

if(isset($detheme_config_demo17)) {
	$detheme_config=$detheme_config_demo17;
}
