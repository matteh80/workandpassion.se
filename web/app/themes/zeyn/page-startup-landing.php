...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo14.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo14,$post;

if(isset($detheme_config_demo14)) {
	$detheme_config=$detheme_config_demo14;
}
