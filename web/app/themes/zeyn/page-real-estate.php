...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo4.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo4,$post;

if(isset($detheme_config_demo4)) {
	$detheme_config=$detheme_config_demo4;
}
