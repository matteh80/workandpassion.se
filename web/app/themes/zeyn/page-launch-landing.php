...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo16.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo16,$post;

if(isset($detheme_config_demo16)) {
	$detheme_config=$detheme_config_demo16;
}
get_header();
