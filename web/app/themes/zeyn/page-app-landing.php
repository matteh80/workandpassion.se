...
wp_register_style( 'custom-theme-style',get_template_directory_uri() . '/css/customstyle_demo13.css', array(), '', 'all' );

global $detheme_config,$detheme_config_demo13,$post;

if(isset($detheme_config_demo13)) {
	$detheme_config=$detheme_config_demo13;
}

locate_template('demo/header-app-landing.php',true);
//get_header();
