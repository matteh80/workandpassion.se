function add_megamenu_item(e, url, title, classes){
    e.preventDefault();
    ...
    data = {
        ...
        'menu-item[-1][menu-item-classes]': classes,
    };
...
jQuery(document).ready(function(){
    jQuery('#submit-megamenu-column').on('click', function(e) {add_megamenu_item(e, '#MegaMenuColumn', 'Mega Menu Column', 'col-sm-3');});
